...
Env vars:
  ...
  GH_LOGIN      user to summarise (default: itsfizys)
...
#  * privacy is PUBLIC — otherwise a personal token sees private repos and a
#    workflow token doesn't, so language totals disagree between environments.
QUERY = """
...
def main():
    ...
    login   = os.environ.get("GH_LOGIN", "itsfizys")
